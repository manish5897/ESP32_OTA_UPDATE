...
int id = 1;
int interval = 3600000;               // ota timer interval 


#define WIFI_SSID "ssid"
#define WIFI_PASS "password"
#define SERVER_IP   "192.168.1.1"               // set your ip adress
#define SERVER_PORT "80"                        // port no
#define FW_FILENAME "/media/hello-world.bin"    // path
...
static void ota_task(void *pvParameter)
{
    ...
    */
    ...
    int get_len = asprintf(&http_request, GET_FORMAT, FW_FILENAME, SERVER_IP, SERVER_PORT);
    if (get_len < 0) {
